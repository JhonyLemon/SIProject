    ...
    <section>
        ...
        <div class="control">
            ...
            <?php if (isset($previous) && $previous) : ?>
                <form class="post-select" method="post" action="index.php?action=post&id=<?php echo $previous['IDpost'] ?>&valid=<?php echo $previous['valid'] ?>" id="previousPost" name="previous">
                    <input type="image" class="icons" name="previousPostButton" value="" src="<?php echo IconsURL('LeftPost') ?>">
                </form>
            <?php endif; ?>
            ...
            <?php if (isset($vote)) : ?>
                <?php if ($vote) : ?>
                    <?php if ($vote['vote']) : ?>
                        <img class="icons" onclick="onClick(event)" id="upvote.OFF" src="<?php echo IconsURL('UpVoteON') ?>" />
                        <div class="points"><?php echo $points['0']; ?></div>
                        <img class="icons" id="downvote.ON" src="<?php echo IconsURL('DownVoteOFF') ?>" />
                    <?php else : ?>
                        <img class="icons" id="upvote.ON" src="<?php echo IconsURL('UpVoteOFF') ?>" />
                        <div class="points"><?php echo $points['0']; ?></div>
                        <img class="icons" onclick="onClick(event)" id="downvote.OFF" src="<?php echo IconsURL('DownVoteON') ?>" />
                    <?php endif; ?>
                <?php else : ?>
                    <img class="icons" onclick="onClick(event)" id="upvote.ON" src="<?php echo IconsURL('UpVoteOFF') ?>" />
                    <div class="points"><?php echo $points['0']; ?></div>
                    <img class="icons" onclick="onClick(event)" id="downvote.ON" src="<?php echo IconsURL('DownVoteOFF') ?>" />
                <?php endif; ?>
            <?php else : ?>
                <img class="icons" id="upvote.ON" src="<?php echo IconsURL('UpVoteOFF') ?>" />
                <div class="points"><?php echo $points['0']; ?></div>
            ...
            <?php if (isset($favorite)) : ?>
                <?php if ($favorite) : ?>
                    <img class="icons" onclick="onClick(event)" id="favorite.OFF" src="<?php echo IconsURL('FavoriteON') ?>" />
                <?php else : ?>
                    <img class="icons" onclick="onClick(event)" id="favorite.ON" src="<?php echo IconsURL('FavoriteOFF') ?>" />
                <?php endif ?>
            <?php else : ?>
                <img class="icons" id="favorite.ON" src="<?php echo IconsURL('FavoriteOFF') ?>" />
            <?php endif; ?>

            <?php if (array_key_exists('permission', $_SESSION) && ($_SESSION['permission'] == 'admin' || $_SESSION['permission'] == 'moderator')) : ?>
                <?php if ($valid) : ?>
                    <img class="icons" onclick="onClickModal(event)" id="validate" src="<?php echo IconsURL('Valid') ?>" />
                <?php endif ?>
                <img class="icons" onclick="onClickModal(event)" id="delete" src="<?php echo IconsURL('Delete') ?>" />
            ...
            <?php if (isset($next) && $next) : ?>
                <form class="post-select" method="post" action="index.php?action=post&id=<?php echo $next['IDpost'] ?>&valid=<?php echo $next['valid'] ?>" id="nextPost" name="next">
                    <input type="image" class="icons" name="nextPostButton" value="" src="<?php echo IconsURL('RightPost') ?>">
                </form>
            <?php endif; ?>
